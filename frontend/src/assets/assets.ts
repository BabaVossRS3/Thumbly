import thumb1 from "./thumb_1.jpg";
import thumb2 from "./thumb_2.jpg";
import thumb3 from "./thumb_3.jpg";
import thumb4 from "./thumb_4.jpg";
import thumb5 from "./thumb_5.jpg";
import thumb6 from "./thumb_6.jpg";
import thumb7 from "./thumb_7.jpg";
import freeBanner from "./Free (1).png";
import basicBanner from "./Basic (1).png";
import proBanner from "./Pro (1).png";
import enterpriseBanner from "./enterprise (1).png";

export const planBanners = {
    free: freeBanner,
    basic: basicBanner,
    pro: proBanner,
            ...
            <div class="flex pt-14">
                ...
                <aside class="fixed left-0 top-14 bottom-0 w-60 bg-yt px-3 py-4 overflow-y-auto hidden lg:block">
                    <nav class="space-y-2">
                        ...
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://i.pravatar.cc/36?img=1" class="rounded-full size-7" /> MrBeast </a>
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://i.pravatar.cc/36?img=2" class="rounded-full size-7" /> Fireship </a>
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://i.pravatar.cc/36?img=3" class="rounded-full size-7" /> Veritasium </a>
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://i.pravatar.cc/36?img=4" class="rounded-full size-7" /> MKBHD </a>
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://i.pravatar.cc/36?img=5" class="rounded-full size-7" /> Linus Tech Tips </a>
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://i.pravatar.cc/36?img=6" class="rounded-full size-7" /> Kurzgesagt </a>
                    </nav>
                </aside>
                <!-- ========== MAIN CONTENT ========== -->
